    ...
    <section id="portfolio" class="portfolio section-bg">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-industry">
                    <div class="portfolio-wrap">
                        <img src="assets/img/cahar.jpeg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Cahar</h4>
                            <p>Industry</p>
                            <div class="portfolio-links">
                                <a href="assets/img/cahar.jpeg" data-gall="portfolioGallery" class="venobox" title="Web 2"><i class="icofont-eye"></i></a>
                                <a href="portfolio-details.html" title="More Details"><i class="icofont-external-link"></i></a>
                            </div>
                        </div>
                    </div>
